...
func (x *GetOrderRespnse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOrderRespnse) ProtoMessage() {}

func (x *GetOrderRespnse) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOrderRespnse.ProtoReflect.Descriptor instead.
func (*GetOrderRespnse) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{4}
}

func (x *GetOrderRespnse) GetOrder() *Order {
	if x != nil {
		return x.Order
	}
	return nil
...
const file_order_proto_rawDesc = "" +
	...
	"\x13GetOrdersForAccount\x12\x1e.pb.GetOrdersForAccountRequest\x1a\x1f.pb.GetOrdersForAccountResponse\"\x00B,Z*github.com/adarshbaddies/go-learn/order/pbb\x06proto3"
...
var file_order_proto_goTypes = []any{
	...
	(*GetOrderRespnse)(nil),               // 4: pb.GetOrderRespnse
...
var file_order_proto_depIdxs = []int32{
	...
	0, // 3: pb.GetOrderRespnse.order:type_name -> pb.Order
